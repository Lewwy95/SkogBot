...
// Imports
const { ActionRowBuilder, ButtonBuilder, ButtonStyle, ModalBuilder, TextInputBuilder, TextInputStyle, EmbedBuilder, ComponentType, ModalBuilder } = require('discord.js'); // Allows us to use Modals and Buttons
...
async function mindReader(client) {
    ...
    const buttonCollector = message.createMessageComponentCollector({ componentType: ComponentType.Button, time: 900000 }); // 15 Minutes (900000ms)
