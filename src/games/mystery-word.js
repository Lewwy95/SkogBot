...
module.exports = async (client) => {
    ...
    if (selection === undefined) {
        channel.send({ content: 'Today\'s game was Mystery Word but there are no more questions left. Please try again tomorrow!' });
        return;
    }
    ...
    submitAnswer.onClick(
        async (buttonInteraction) => {
            ...
            if (sanitisedUserAnswer.toLowerCase().includes(selection.word.toLowerCase())) {
